...
#### Where to save data and figures
output_data_main_data_file = r"C:/Users/jpark/vscode/DutchEconomyTen_Charts/data/01_get_data/mo_data/"
...
def macro_data_cbs(identifier, verbose = False):
    ...
    if verbose:
        ...
        tables.to_csv(output_data_main_data_file + "cbs_table_list.csv")
        data.to_csv(output_data_main_data_file + "unprocessed_mo_data.csv")
    ...
    # save locally
    data_all.to_csv(output_data_main_data_file + "employment_all_genders_mo.csv")
    ...
    # save locally
    data_all.to_csv(output_data_main_data_file + "employment_females_mo.csv")
