...
def producer_confidence_2():
    ...
    bc_1_qt.to_csv(output + "/cbs_BusinessConfidence_qt.csv")

    bc_1_mo = bc_1[mo_data]
    bc_1_mo.columns = [col + "_BusinessConfidence" for col in bc_1_mo.columns]
    bc_1_mo.to_csv(output + "/cbs_BusinessConfidence_mo.csv")
...
def producer_confidence_3():
    ...
    bc_1_qt.to_csv(output + "/cbs_BusinessSituationPastThreeMonths_qt.csv")

    bc_1_mo = bc_1[mo_data]
    bc_1_mo.columns = [col + "BusinessSituationPastThreeMonths" for col in bc_1_mo.columns]
    bc_1_mo.to_csv(output + "/cbs_BusinessSituationPastThreeMonths_mo.csv")
...
def producer_confidence_4():
    ...
    bc_1_qt.to_csv(output + "/cbs_BusinessSituationNextThreeMonths_qt.csv")

    bc_1_mo = bc_1[mo_data]
    bc_1_mo.columns = [col + "BusinessSituationNextThreeMonths" for col in bc_1_mo.columns]
    bc_1_mo.to_csv(output + "/cbs_BusinessSituationNextThreeMonths_mo.csv")
...
def producer_confidence_5():
    ...
    bc_1_qt.to_csv(output + "/cbs_UncertaintyIndicatorBusinessClimate_qt.csv")

    bc_1_mo = bc_1[mo_data]
    bc_1_mo.columns = [col + "_UncertaintyIndicatorBusinessClimate" for col in bc_1_mo.columns]
    bc_1_mo.to_csv(output + "/cbs_UncertaintyIndicatorBusinessClimate_mo.csv")
