...
def mo_data():
    ...
    input_path =  os.path.abspath("C:/Users/jpark/vscode/NowCast_Data_Analysis_scripts/output_mo_qt")
    output_path = os.path.abspath("C:/Users/jpark/vscode/NowCast_Data_Analysis_scripts/output_combined")
    ...
    # drop data
    df_final_mo.dropna(thresh = 250, axis=1, inplace=True) #########################################################
    col_after_removing = df_final_mo.columns

    print("Columns month removed: ", len(col_after_removing))
...
def qt_data():
    ...
    # remove empty columns or columns with little data
    print("Number of quarter columns before removing: ", len(df_final_qt.columns))
